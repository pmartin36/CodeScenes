...
CodeScenes fixes both by making your scene **code**:
...
Hit **CodeScenes ▸ Build** — the scene appears in Unity, wired up and ready.
...
2. **Write a scene** — create `Assets/Scenes/MainMenu.cs`:
   ...
   ```
3. **See it appear** — click **Build** in the CodeScenes panel and your scene materializes. Prefer
...
(*Package Manager ▸ CodeScenes ▸ Samples ▸ Import*) and follow its README.

---

## How it works

Your builder file is the source of truth. CodeScenes compares what your code describes against
